...
parser.add_argument(
    "--input-path", default="input.wav", help="The input audio to inject noise into"
)
parser.add_argument(
    "--noise-path", default="noise.wav", help="The noise file to mix in"
)
parser.add_argument(
    "--output-path", default="output.wav", help="The noise file to mix in"
)
parser.add_argument(
    "--sample-rate", default=16000, help="Sample rate to save output as"
)
parser.add_argument(
    "--noise-level",
    type=float,
